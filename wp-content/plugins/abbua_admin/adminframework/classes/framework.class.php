...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_menu() {
  	...
  	if( $args['menu_type'] == 'submenu' ) {
  		$parent = post_type_exists( $args['menu_parent'] );
  		if ($parent) {
  			$menu_parent = 'edit.php?post_type='.$args['menu_parent'];
  			call_user_func( 'add_submenu_page', $menu_parent, $args['menu_title'], $args['menu_title'], $args['menu_capability'], $args['menu_slug'], array( &$this, 'admin_page' ) );
  		} else {
  ...
  public function admin_page() {
	...
	echo '<div class="wrap"><h1 class="wp-heading-inline">'. $this->settings['framework_title'] .'</h1>';
  	...
  	echo '<h1>'. $this->settings['framework_title'] .' <small>'.$this->settings['framework_subtitle'].'</small></h1>';
  	echo '<fieldset>';
	  ...
	  echo '<div class="cs-block-left">CastorStudio Framework</div>';
