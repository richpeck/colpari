...
if( ! function_exists( 'cs_framework_init' ) && ! class_exists( 'CSFramework' ) ) {
  function cs_framework_init() {
    ...
    // Custom Post Type
    // posttype classes
    cs_locate_template( 'classes/posttype/posttype.php' );
    cs_locate_template( 'classes/posttype/taxonomy.php' );
    cs_locate_template( 'classes/posttype/columns.php'  );

    // posttype config
    cs_locate_template( 'config/posttype.config.php'  ); 
    // -------------------------------------------------------
  ...
  add_action( 'after_setup_theme', 'cs_framework_init', 10 );
}
