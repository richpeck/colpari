...
class ABBUA_Theme_forgedsteel{
	public function __construct(){
        $this->theme_name   = 'forgedsteel';
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('ForgedSteel Theme Settings'),
				),
				array(
	...
	public function parse_settings($settings){
		...
		$theme = array(
			...
			'background2'	=> '#2b303a',				// dark sidebar background
			'background3'	=> '#242830',				// dark sidebar active background
			'background4'	=> '#c4c7cb',				// light sidebar background
			'background5'	=> '#b1b4b9',				// light sidebar active background
			...
			// Border
			'border1'		=> '#242830',		// Sidebar brand border
			'border2'		=> '#c3c4c6',		// Navbar border

			// Text Colors Scheme
			'text1'			=> 'rgb(68, 68, 68)',		// body text
            'text2'			=> '#767c86',				// light navbar text color, light navbar toolbar text color, dark brand subtitle text color
            'text3'         => 'rgb(185, 180, 187)',    // dark navbar text color, dark navbar toolbar text, light brand subtitle text color
			'text4'			=> '#73767b',	// dark sidebar text
			'text5'			=> '#9b9da0',	// dark sidebar text hover
			'text6'			=> '#767c86',		// light sidebar text
			'text7'			=> '#9da1a8',		// light sidebar text hover
		);
