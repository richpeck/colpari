...
class ABBUA_Theme_abbua{
	public function __construct(){
        $this->theme_name   = 'abbua';
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('ABBUA Theme Settings'),
				),
				array(
	...
	public function parse_settings($settings){
		...
		$body_background 		= new Color('#eff1f3');
		...
		$theme = array(
			...
			'background2'	=> '#4a416c',				// dark sidebar background
			'background3'	=> '#3d3659',				// dark sidebar active background
			'background4'	=> '#dedee5',				// light sidebar background
			'background5'	=> '#cecdd8',				// light sidebar active background
			...
			// Border
			'border1'		=> '#443c63',		// Sidebar brand border
			'border2'		=> '#d5dfe3',		// aaaeab	// Navbar border

			// Text Colors Scheme
			'text1'			=> 'rgb(68, 68, 68)',		// body text
            'text2'			=> '#acc0c8',	// light navbar text color, light navbar toolbar text color, dark brand subtitle text color
            'text3'         => '#cecdd8',    // dark navbar text color, dark navbar toolbar text, light brand subtitle text color
			'text4'			=> '#8b86a1',	// dark sidebar text
			'text5'			=> '#aca8bc',	// dark sidebar text hover
			'text6'			=> '#9d9cb2',		// light sidebar text
			'text7'			=> '#6c6b8b',		// light sidebar text hover
		);
