...
class ABBUA_Theme_default{
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('Default Theme Settings'),
				),
				array(
	...
	public function parse_settings($settings){
		...
		$body_background 		= new Color('#eff3f6');
		...
		$theme = array(
			...
			'background2'	=> '#222c3c',				// dark sidebar background
			'background3'	=> '#1d2531',				// dark sidebar active background
			'background4'	=> '#b9c7d1',				// light sidebar background
			'background5'	=> '#a2b5c2',				// light sidebar active background
			'background6'	=> 'rgb(255,255,255)',		// light navbar background
			'background7'	=> $body_background_light,

			
			// Buttons
			'button1'		=> '#1a98f7',				// Button 1 Ini
			'button2'		=> '#1485db',				// Button 1 End

			// Border
			'border1'		=> '#2a3547',				// Sidebar brand border
			'border2'		=> '#e6eaee',				// Navbar border

			// Text Colors Scheme
			'text1'			=> 'rgb(68, 68, 68)',		// body text
            'text2'			=> '#7f8fa4',				// light navbar text color, light navbar toolbar text color, dark brand subtitle text color
            'text3'         => '#565e57',   			// dark navbar text color, dark navbar toolbar text, light brand subtitle text color
			'text4'			=> '#b7c0cd',				// dark sidebar text
			'text5'			=> '#ffffff',				// dark sidebar text hover
			'text6'			=> '#7390a4',				// light sidebar text
			'text7'			=> '#5c7d95',				// light sidebar text hover
		);
