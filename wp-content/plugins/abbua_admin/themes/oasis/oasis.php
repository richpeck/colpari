...
class ABBUA_Theme_oasis{
	public function __construct(){
        $this->theme_name   = 'oasis';
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('Oasis Theme Settings'),
				),
				array(
	...
	public function parse_settings($settings){
		...
		$body_background 		= new Color('#e1e0df');
		...
		$theme = array(
			...
			'background2'		=> '#5c5552',				// dark sidebar background
			'background3'		=> '#4c4644',				// dark sidebar active background
			'background4'		=> '#ccc7c3',				// light sidebar background
			'background5'		=> '#c1bcb8',				// light sidebar active background
			...
			// Border
			'border1'		=> '#544e4b',		// Sidebar brand border
			'border2'		=> '#ccc7c3',// aaaeab	// Navbar border

			// Text Colors Scheme
			'text1'			=> 'rgb(68, 68, 68)',		// body text
            'text2'			=> '#d2d0cf',	// light navbar text color, light navbar toolbar text color, dark brand subtitle text color
            'text3'         => '#565e57',    // dark navbar text color, dark navbar toolbar text, light brand subtitle text color
			'text4'			=> '#979290',	// dark sidebar text
			'text5'			=> '#b4b1b0',	// dark sidebar text hover
			'text6'			=> '#a39b94',		// light sidebar text
			'text7'			=> '#8f857d',		// light sidebar text hover
		);
