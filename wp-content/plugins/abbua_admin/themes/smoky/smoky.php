...
class ABBUA_Theme_smoky{
	public function __construct(){
        $this->theme_name   = 'smoky';
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
                array(
					'type'			=> 'subheading',
					'content'		=> __('Smoky Theme Settings'),
				),
				array(
	...
	public function parse_settings($settings){
		...
		$body_background 		= new Color('#f6f6f6');
		...
		$theme = array(
			...
			'background2'	=> '#333645',				// dark sidebar background
			'background3'	=> '#1e202c',				// dark sidebar active background
			'background4'	=> '#ececed',				// light sidebar background
			'background5'	=> '#e5e3e3',				// light sidebar active background
			...
			// Border
			'border1'		=> '#2f323f',		// Sidebar brand border
			'border2'		=> '#ebebeb',		// aaaeab	// Navbar border

			// Text Colors Scheme
			'text1'			=> '#747474',		// body text
            'text2'			=> '#504f54',		// light navbar text color, light navbar toolbar text color, dark brand subtitle text color
            'text3'         => '#cecdd8',   // dark navbar text color, dark navbar toolbar text, light brand subtitle text color
			'text4'			=> '#96989d',		// dark sidebar text
			'text5'			=> '#e6e7ec',		// dark sidebar text hover
			'text6'			=> '#b3b4b9',		// light sidebar text
			'text7'			=> '#8d8f96',		// light sidebar text hover
		);
		...
		if ($style == 'style1'){
			...
			$brand_subtitle_color		= $theme['text4'];
			...
			$navbar_color 				= $theme['text4'];
			$navbar_toolbar_color 		= $theme['text4'];
			...
			$brand_color				= $theme['text2'];
			$brand_subtitle_color		= $theme['text3'];
