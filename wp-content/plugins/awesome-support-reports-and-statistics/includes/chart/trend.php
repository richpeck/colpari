...
$result_data = rns_get_trend_tickets_according_to_chart_type( $second, $statuses, $search_filter, $status_get, $staff_get,  $sDate_get, $eDate_get,  $state_get , $taxonomy_get , $cus_fields_get , $ticket_author  );

$points = $result_data['points'];
$labels = $result_data['labels'];
$colors = $result_data['colors'];

rns_get_trend_chart_by_points_label_and_chart_type( $points , $labels , $colors ,  $second , $chart_type );
